...
const App = () => {
  ...
  const onSetChartData = useCallback((chartDataCity) => {
    setAllChartData((chartData) => {
      console.log("Test")
      console.log({...chartData, ...chartDataCity})
      return {...chartData, ...chartDataCity}
    })
  }, [setAllChartData])
  ...
  const onSetForecastItemList = useCallback((forecastItemListCity) => {
    setForecastItemList((forecastItemList) => {
      console.log("Test2")
      console.log({...forecastItemList, ...forecastItemListCity })
      return {...forecastItemList, ...forecastItemListCity }
    })
  }, [setForecastItemList])
